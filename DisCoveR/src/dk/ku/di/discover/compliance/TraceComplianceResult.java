...
public class TraceComplianceResult {
	...
	public TraceComplianceResult(String traceId, boolean expectedResult, boolean actualResult) {
		super();
	...
	public TraceComplianceResult(String traceId, boolean expectedResult, boolean actualResult, String reasonForFail) {
		super();
		this.traceId = traceId;
		this.expectedResult = expectedResult;
		this.actualResult = actualResult;
