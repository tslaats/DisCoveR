...
@XmlRootElement(name = "DCRModelAdvice")       
public class DCRModelAdvice {
	@XmlElement(name = "Relation")
	public ArrayList<RelationAdvice> relations;
	
	public DCRModelAdvice()
	{
		relations = new ArrayList<RelationAdvice>();
	}
}
