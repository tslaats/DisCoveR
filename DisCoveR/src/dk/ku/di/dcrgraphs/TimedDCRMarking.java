...
public class TimedDCRMarking extends DCRMarking {

	HashMap<String, Integer> executedTime = new HashMap<String, Integer> ();
	HashMap<String, Integer> pendingTime = new HashMap<String, Integer> ();	
	
	public TimedDCRMarking() {
